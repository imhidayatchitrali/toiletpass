...
import { Building2, Mail, Lock, MapPin, Phone, Clock, Euro, Bath, DoorClosed } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
          {isLogin ? 'Espace Partenaire' : 'Devenir Partenaire'}
        </h2>
                ...
                <div>
                  ...
                  <div className="mt-1 relative">
                    <input
                      type="text"
                      required
                      className="appearance-none block w-full px-3 py-2 pl-10 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                  ...
                  <div>
                    ...
                    <div className="mt-1 relative">
                      <input
                        ...
                        required
                        className="appearance-none block w-full px-3 py-2 pl-10 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
                        value={formData.toiletsCount}
                        onChange={(e) => setFormData({ ...formData, toiletsCount: parseInt(e.target.value) })}
                      />
                  ...
                  <div>
                    ...
                    <div className="mt-1 relative">
                      <input
                        ...
                        onChange={(e) => setFormData({ ...formData, showersCount: parseInt(e.target.value) })}
                      />
